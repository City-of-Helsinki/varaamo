...
function PaymentFailed({ t, resourceId }) {
  return (
    <div className="app-ReservationFailedPage__contentbox">
      ...
      {resourceId && (
        <Link
          className="app-ReservationFailedPage__link"
      ...
      <Link
        className="app-ReservationFailedPage__link app-ReservationFailedPage__link--last"
        to="/my-reservations"
      >
