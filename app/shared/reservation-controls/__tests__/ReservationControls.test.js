...
describe('shared/reservation-controls/ReservationControls', () => {
  ...
  function getWrapper(reservation, isAdmin = false, isStaff = false) {
    ...
    const resource = {
      ...defaultResource,
      user_permissions: {
        ...defaultResource.user_permissions,
        is_admin: isStaff,
      },
    };
    const props = {
