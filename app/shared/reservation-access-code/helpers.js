...
export const isAccessCodeGenerated = (reservation) =>
  has(reservation, 'access_code') && reservation.access_code !== null;
...
export const isAccessCodePending = (reservation, resource) => {
  ...
  return (
    !isAccessCodeGenerated(reservation) &&
    resource.generate_access_codes === false
  );
};

export const isReservationCancelled = (reservation) =>
